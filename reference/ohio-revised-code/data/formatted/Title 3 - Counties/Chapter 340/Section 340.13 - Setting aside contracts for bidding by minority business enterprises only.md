Source: https://codes.ohio.gov/ohio-revised-code/section-340.13
...
(G) Within ninety days after the beginning of each fiscal year, each board shall file a report with the department of behavioral health that shows for that fiscal year the name of each minority business enterprise and EDGE business enterprise with which the board entered into a contract, the value and type of each such contract, the total value of contracts awarded under divisions (C) and (D) of this section, the total value of contracts awarded for the purchases of equipment, materials, supplies, or services, other than contracts entered into under section 340.036 of the Revised Code, and the total value of contracts entered into for construction.
...
Last updated July 28, 2025 at 10:53 AM
