Source: https://codes.ohio.gov/ohio-revised-code/section-5165.521
...
(A) Except as provided in divisions (B), (C), and (D) of this section, the department of medicaid may withhold from payment due an exiting operator under the medicaid program the total amount specified in the notice provided under division (C) of section 5165.52 of the Revised Code that the exiting operator owes or may owe to the department under the medicaid program.
...
(1) If the exiting operator, entering operator, or affiliated operator assumes liability for the total, actual amount of debt the exiting operator owes the department under the medicaid program as determined under section 5165.525 of the Revised Code, the department shall not make the withholding.
...
(1) If the exiting operator or affiliated operator assumes liability for the total, actual amount of debt the exiting operator owes the department under the medicaid program as determined under section 5165.525 of the Revised Code, the department shall not make the withholding.
...
(a) The total, actual amount of debt the exiting operator owes the department under the medicaid program as determined under section 5165.525 of the Revised Code;
...
(3) It must provide that the department, after determining under section 5165.525 of the Revised Code the actual amount of debt the exiting operator owes the department under the medicaid program, may deduct the lesser of the following from medicaid payments made to the operator who executes the successor liability agreement:
...
Last updated October 6, 2023 at 10:45 AM
